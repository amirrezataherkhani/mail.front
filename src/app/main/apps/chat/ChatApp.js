...
import { DOCUMENT_REFRESH } from "app/auth/store/actions";
...
function ChatApp(props) {
    ...
    const getContactsQuery = GetContactsUseQuery();
    ...
    // const setUserDataOnLocalStorage = () => {
    ...
    // useEffect(() => {
    //     dispatch({type:DOCUMENT_REFRESH})
    // }, []);
                ...
                <div className={classes.contentCard}>
                    <Hidden mdUp>
                        <Drawer
                            ...
                            onClose={() =>
                                dispatch(Actions.closeMobileChatsSidebar())
                            }
                            classes={{
                                paper: clsx(
                                    classes.drawerPaper,
